...
export default ({ label, file, templateKey, pageSlug, additionalFields }) => {
  const optionalFields = {
    ...
    showBio: {
      label: 'Show Bio Summary Section',
      name: 'showBio',
      widget: 'boolean',
      default: true,
      required: false,
      hint: 'Show the short bio summary section on the homepage.',
    },
    showSameAs: {
      label: 'Show External Profiles Row',
      name: 'showSameAs',
      widget: 'boolean',
      default: true,
      required: false,
      hint: 'Show the row of external profile links (LinkedIn, Crunchbase, etc.).',
    },
    showPosts: {
      label: 'Show Featured Blog Posts',
      name: 'showPosts',
      widget: 'boolean',
      default: true,
      required: false,
      hint: 'Show the 3 most recent blog posts on the homepage.',
    },
    showPress: {
      label: 'Show Press Mentions Strip',
      name: 'showPress',
      widget: 'boolean',
      default: false,
      required: false,
      hint: 'Show the press mentions strip on the homepage.',
    },
    showGallery: {
      ...
      default: true,
      required: false,
      hint: 'Show a preview of the 6 most recent gallery images.',
    },
    showCTA: {
      ...
      default: true,
      required: false,
      hint: 'Show the contact call-to-action section at the bottom of the homepage.',
    },
    bioLabel: {
      ...
      widget: 'string',
      required: false,
      hint: 'Eyebrow label above the bio section, e.g. "About"',
    },
    linksLabel: {
      label: 'External Links Section Label',
      name: 'linksLabel',
      widget: 'string',
      required: false,
      hint: 'Eyebrow label above the external profiles row, e.g. "Find Me On"',
    },
    postsLabel: {
      label: 'Posts Section Label',
      name: 'postsLabel',
      widget: 'string',
      required: false,
      hint: 'Eyebrow label above featured posts, e.g. "Latest Writing"',
    },
    pressLabel: {
      ...
      widget: 'string',
      required: false,
      hint: 'Eyebrow label above the press strip, e.g. "As Seen In"',
    },
    galleryLabel: {
      ...
      widget: 'string',
      required: false,
      hint: 'Eyebrow label above the gallery preview, e.g. "Gallery"',
    },
    ctaLabel: {
      ...
      widget: 'string',
      required: false,
      hint: 'Eyebrow label above the CTA section, e.g. "Get In Touch"',
    },
    ctaHeadline: {
      label: 'CTA Headline',
      name: 'ctaHeadline',
      widget: 'string',
      required: false,
      hint: 'Large headline for the contact CTA section.',
    },
    ctaBody: {
      label: 'CTA Body Text',
      name: 'ctaBody',
      widget: 'text',
      required: false,
      hint: 'Short paragraph under the CTA headline.',
    },
    ctaButton: {
      label: 'CTA Button',
      name: 'ctaButton',
      widget: 'object',
      required: false,
      hint: 'Button shown in the CTA section.',
      fields: [
        {
          label: 'Button Text',
          name: 'label',
        ...
        },
        {
          ...
          widget: 'string',
          required: false,
          hint: 'A URL or mailto: link, e.g. "mailto:hello@example.com"',
        },
      ],
    },
  }
